...
{
    options.AddPolicy("AdminOnly", policy => policy.RequireClaim(UserType.Admin.ToString()));

    options.AddPolicy("CustomerOnly", policy => policy.RequireRole(UserType.Customer.ToString()));
